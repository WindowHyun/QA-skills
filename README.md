...
[`examples/example-report.md`](examples/example-report.md) — 샘플 주문 서비스의 변경(3파일, +59/-32)에 대해
이 스킬이 생성한 리포트. 위험 지점 14건 / 테스트 케이스 25건 / 확정 결함 16건, 코드 근거 인용 159회.
샘플에 심어둔 결함 14건을 전부 발견했다.
